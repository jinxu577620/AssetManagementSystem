    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.saleName" placeholder="销售名称" class="handle-input mr10"></el-input>
                <el-date-picker
            ...
            >
                ...
                <el-table-column prop="saleName" label="销售" align="center"></el-table-column>
                ...
                <el-table-column label="登记时间" width="180" align="center">
                    <template slot-scope="scope">
...
export default {
    ...
    methods: {
        async getData() {
            ...
            this.$apis.getAllCustomers(this.query).then(res =>{
        ...
        remainDays(val) {
            ...
            else if (days === 0)return moment(val).diff(moment(), 'hour')+' 时';
            else return days+' 天';
        },
        // 编辑
        ...
        async exportExcel() {
            ...
            this.$apis.getAllCustomers({
                ...
                setTimeout(()=>{
                    ...
                    try {
                        FileSaver.saveAs(new Blob([wbout], {type: 'application/octet-stream'}), '所有客户.xlsx')
                    } catch (e) {
